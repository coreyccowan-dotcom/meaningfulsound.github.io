...
TABS = [
    ...
    ("Live",
     "Where songs and setlists are deployed to the rig in sequence. Walk a setlist "
     "section by section; each advance sends the right preset to every pedal on "
     "the board. One action changes the whole rig."),
]
